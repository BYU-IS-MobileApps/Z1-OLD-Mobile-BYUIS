...
/**
 * Adapter class for the user preferences. Note that it is a singleton
 * class also.
 */
public class UserSettingsAdapter 
{
	...
	private static UserSettingsAdapter instance;
	...
	{
		if(instance == null)
			instance = new UserSettingsAdapter(context.getApplicationContext().
	 ...
	 */
	private UserSettingsAdapter(SharedPreferences prefs) 
	{
		this.prefs = prefs;
	}
	...
	/**
	 * Deletes all of the current data.
	 */
